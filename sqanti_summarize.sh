...
grep 'full-splice_match' *flair.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique FSM:\t" $1}' >> sqanti_summary.txt #for unique fsm
grep 'full-splice_match' *flair.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | wc -l | awk '{print "RM:\t" $1}' >> sqanti_summary.txt #for rm
grep 'full-splice_match' *flair.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | cut -f8 | sort | uniq | wc -l | awk '{print "Unique RM:\t" $1}' >> sqanti_summary.txt #for unique rm
grep 'incomplete-splice_match' *flair.*classification.txt | wc -l | awk '{print "ISM:\t" $1}' >> sqanti_summary.txt #for ism
grep 'incomplete-splice_match' *flair.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique ISM:\t" $1}' >> sqanti_summary.txt #for unique ism
...
grep 'full-splice_match' *stringtie.guided.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique FSM:\t" $1}' >> sqanti_summary.txt #for unique fsm
grep 'full-splice_match' *stringtie.guided.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | wc -l | awk '{print "RM:\t" $1}' >> sqanti_summary.txt #for rm
grep 'full-splice_match' *stringtie.guided.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | cut -f8 | sort | uniq | wc -l | awk '{print "Unique RM:\t" $1}' >> sqanti_summary.txt #for unique rm
grep 'incomplete-splice_match' *stringtie.guided.*classification.txt | wc -l | awk '{print "ISM:\t" $1}' >> sqanti_summary.txt #for ism
grep 'incomplete-splice_match' *stringtie.guided.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique ISM:\t" $1}' >> sqanti_summary.txt #for unique ism
...
grep 'full-splice_match' *stringtie.free.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique FSM:\t" $1}' >> sqanti_summary.txt #for unique fsm
grep 'full-splice_match' *stringtie.free.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | wc -l | awk '{print "RM:\t" $1}' >> sqanti_summary.txt #for rm
grep 'full-splice_match' *stringtie.free.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | cut -f8 | sort | uniq | wc -l | awk '{print "Unique RM:\t" $1}' >> sqanti_summary.txt #for unique rm
grep 'incomplete-splice_match' *stringtie.free.*classification.txt | wc -l | awk '{print "ISM:\t" $1}' >> sqanti_summary.txt #for ism
grep 'incomplete-splice_match' *stringtie.free.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique ISM:\t" $1}' >> sqanti_summary.txt #for unique ism
...
grep 'full-splice_match' *rb.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique FSM:\t" $1}' >> sqanti_summary.txt #for unique fsm
grep 'full-splice_match' *rb.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | wc -l | awk '{print "RM:\t" $1}' >> sqanti_summary.txt #for rm
grep 'full-splice_match' *rb.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | cut -f8 | sort | uniq | wc -l | awk '{print "Unique RM:\t" $1}' >> sqanti_summary.txt #for unique rm
grep 'incomplete-splice_match' *rb.*classification.txt | wc -l | awk '{print "ISM:\t" $1}' >> sqanti_summary.txt #for ism
grep 'incomplete-splice_match' *rb.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique ISM:\t" $1}' >> sqanti_summary.txt #for unique ism
...
grep 'full-splice_match' *rattle.*classification.txt | grep -e 'reference_match' -e 'mono-exon' | cut -f8 | sort | uniq | wc -l | awk '{print "Unique RM:\t" $1}' >> sqanti_summary.txt #for unique rm
grep 'incomplete-splice_match' *rattle.*classification.txt | wc -l | awk '{print "ISM:\t" $1}' >> sqanti_summary.txt #for ism
grep 'incomplete-splice_match' *rattle.*classification.txt | cut -f8 | sort | uniq | wc -l | awk '{print "Unique ISM:\t" $1}' >> sqanti_summary.txt #for unique ism
